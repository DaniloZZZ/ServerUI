...
namespace ServerUI
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        public Stack ConsStack = new Stack(10);
        ...
        public MainPage()
        {
            ...
            //slider.Header = Data.Inital.slider_header;
        ...
        private void OpnSide_PointerEntered(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            if (sideopn)
            {
                sideopn = false;
